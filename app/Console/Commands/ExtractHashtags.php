...
class ExtractHashtags extends Command
{
     ...
     * نام و توضیحات دستور
     */
    protected $signature = 'telegram:extract-hashtags-group';
    protected $description = 'Extract hashtags from messages and save them to the hashtags field';
    ...
    public function handle() // نقطه ورود دستور
    {
